...
namespace Sfa.Poc.ResultsAndCertification.Configuration
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<ResultsAndCertificationConfiguration>(provider => ResultsAndCertificationConfiguration);
        }
