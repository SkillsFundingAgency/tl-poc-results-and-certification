...
namespace Sfa.Poc.ResultsAndCertification.CsvHelper.Data.Interfaces
{
    public interface IRegistrationRepository : IRepository<TqRegistrationProfile>
    {
        ...
        Task<bool> BulkInsertOrUpdateTqRegistrations(List<TqRegistrationProfile> entities, List<TqRegistrationPathway> pathwayEntities, List<TqRegistrationSpecialism> specialismEntities);
    }
}
